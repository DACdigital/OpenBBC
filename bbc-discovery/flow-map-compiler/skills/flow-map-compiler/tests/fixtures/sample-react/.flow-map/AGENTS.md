...
<!-- AGENT id="summary" -->
A minimal Vite + React + react-router-dom application with one user-facing flow: profile editing. The agent surface is one route at /profile and one write skill against the user record.
<!-- /AGENT -->
