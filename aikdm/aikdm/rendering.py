"""Render Jinja2 XML scaffolds for the generator. Scaffolds carry wizard-copied
and config-derived sections; LLM-synthesized sections are stubbed as comments."""
...
def render_main_prompt_scaffold(config: FlowMapConfig) -> str:
    ...
    return template.render(
        scope=config.scope,
        should_do=config.should_do,
        should_not_do=config.should_not_do,
